...
Aesthetic assessment is central to how humans evaluate visual content. VILA combines **vision and language representations** to predict image aesthetics based on user comments, providing a more **human-aligned evaluation** than purely visual models. Reproducing this model allows us to verify its claims and explore its practical usage.

**Original Paper:**  
Ke, J., et al., *“VILA: Learning Image Aesthetics from User Comments,”* CVPR 2023.  
[📄 PDF](https://arxiv.org/pdf/2303.14302.pdf)
